#
#  Be sure to run `pod spec lint SNImageBrowserViewController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/snlo/SNImageBrowserViewController"
  ...
  s.source       = { :git => "https://github.com/snlo/SNImageBrowserViewController.git", :tag => "#{s.version}" }
